...
#define STRING_CONFIG_H_AUTHOR "Tim Pfeffer" // Who made the changes.
...
#define HOTEND_OFFSET_X { 0.0, 17.95 } // (mm) relative X-offset for each nozzle
#define HOTEND_OFFSET_Y { 0.0, -0.8 }  // (mm) relative Y-offset for each nozzle
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 321.6, 321.6, 1600, 350.8 } //default microstepping { 80.4, 80.4, 400, 87.7 }
...
#define X_MIN_POS -44
#define Y_MIN_POS 0 //-10 wenn endoscope kamera nicht befestigt ist und yhome im motoridler befestigt ist
#define Z_MIN_POS 0
